...
def main():
    # 定义文件路径
    base_dir = "/Users/milespoupart/gitspace/OpenWRT_x86_x64/configs/lean"
    file1 = os.path.join(base_dir, "empty.config")
    file2 = os.path.join(base_dir, "merged.config")
    output = os.path.join(base_dir, "merged_new.config")
    existing_merged = os.path.join(base_dir, "merged.config")
