...
# immortal.config 实际启用且需要 Lienol 版的 8 个子包
# github_partial_clone Lienol openwrt-package main luci-app-fileassistant   luci-app-fileassistant
# github_partial_clone Lienol openwrt-package main luci-app-filebrowser     luci-app-filebrowser
github_partial_clone Lienol openwrt-package main luci-app-guest-wifi      luci-app-guest-wifi
github_partial_clone Lienol openwrt-package main luci-app-ssr-mudb-server luci-app-ssr-mudb-server
